...
const CreateTaskModal = ({ isOpen, onClose, teamId }) => {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-y"
                      placeholder=""
                    />
                  </div>
